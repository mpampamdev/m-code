...
class Backend extends CI_Controller
{
    ...
    public function imageCopy($img_name = null, $file_dir = '', $title="")
    {
    ...
    public function imageRemove($img = null, $ajax = true)
    {
        $json['success'] = false;
    ...
    public function is_allowed($permission = null, $redirect = true)
    {
        if ($permission == null) {
    ...
    public function _cek_password($str)
    {
        if ($str!="") {
