...
class Generate
{
    ...
    public function field_not_primary()
    {
        $fields = $this->ci->db->field_data($this->table);
        foreach ($fields as $field) {
            if ($field->primary_key != 1) {
    ...
    public function content_model_get_field($params="")
    {
        $str = '';
        if (!empty($_POST["show_table"])) {
    ...
    public function content_index($params)
    {
        $str = '';
        if (!empty($_POST["show_table"])) {
            $show_in_table = $_POST["show_table"];
    ...
    public function content_filter($params)
    {
        $str = '';
        if (!empty($_POST["show_table"])) {
            $show_in_table = $_POST["show_table"];
