...
<ul class="nav nav-tabs" role="tablist">
    <li class="nav-item">
        <a class="nav-link active show" data-toggle="tab" href="#awesome" role="tab" aria-selected="true">Font Awesome</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" data-toggle="tab" href="#ion" role="tab" aria-selected="false">Ion</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" data-toggle="tab" href="#themify" role="tab" aria-selected="false">Themify</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" data-toggle="tab" href="#material" role="tab">Material</a>
    </li>
</ul>
...
<div class="tab-content">
    ...
    <div class="tab-pane p-3" id="ion" role="tabpanel">
...
<div class="tab-pane p-3" id="themify" role="tabpanel">
<div class="row icon-demo-content">
        <div class="col-sm-6 col-md-4 col-lg-3">
...
<div class="tab-pane p-3" id="material" role="tabpanel">
<div class="row icon-demo-content">
        <div class="col-sm-6 col-md-4 col-lg-3">
